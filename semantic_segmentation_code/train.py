...
class CFG:
    ...
    coco_train_json = 'train_data4.json' # coco annotation train json 파일
    coco_val_json = 'valid_data4.json' # coco annotation validation json 파일
...
def get_data_utils():
    ...
    # get albumentation transformer for train & valid dataset from augmentation.py
